...
final $typed_data.Uint8List identityDescriptor = $convert.base64Decode('CghJZGVudGl0eRIOCgJpZBgBIAEoCVICaWQ=');
...
final $typed_data.Uint8List productDescriptor = $convert.base64Decode('CgdQcm9kdWN0Eg4KAmlkGAEgASgJUgJpZBISCgRuYW1lGAIgASgJUgRuYW1lEhQKBXByaWNlGAMgASgBUgVwcmljZQ==');
@$core.Deprecated('Use productRequestDescriptor instead')
const ProductRequest$json = const {
  '1': 'ProductRequest',
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
  ],
...
final $typed_data.Uint8List productRequestDescriptor = $convert.base64Decode('Cg5Qcm9kdWN0UmVxdWVzdBIOCgJpZBgBIAEoCVICaWQ=');
